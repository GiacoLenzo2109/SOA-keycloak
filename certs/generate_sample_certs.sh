...
openssl req -new -key "root-ca.key" -out "root-ca.csr" -sha256 -subj '/C=EU/ST=Italy/L=Milan/O=PIEDPIPER/CN=Sample CA'
...
openssl req -new -key "site.key" -out "site.csr" -sha256 -subj "/C=EU/ST=Italy/L=Milan/O=PIEDPIPER/CN=localhost"
